...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_carts_currency" AS ENUM('USD', 'INR');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('processing', 'completed', 'cancelled', 'refunded');
  CREATE TYPE "public"."enum_orders_currency" AS ENUM('USD', 'INR');
  CREATE TYPE "public"."enum_orders_shipping_status" AS ENUM('pending', 'packed', 'shipped', 'delivered');
  CREATE TYPE "public"."enum_transactions_payment_method" AS ENUM('cashfree');
  CREATE TYPE "public"."enum_transactions_status" AS ENUM('pending', 'succeeded', 'failed', 'cancelled', 'expired', 'refunded');
  CREATE TYPE "public"."enum_transactions_currency" AS ENUM('USD', 'INR');
  ...
  CREATE TABLE "orders" (
  	...
  	"shipping_status" "enum_orders_shipping_status" DEFAULT 'pending',
  ...
  CREATE TABLE "transactions" (
  	...
  	"cashfree_order_i_d" varchar,
  	"cashfree_cf_order_i_d" varchar,
  	"cashfree_payment_session_i_d" varchar,
  	"cashfree_shipping_address_j_s_o_n" varchar,
  ...
  ALTER TABLE "products_blocks_content_columns" ADD CONSTRAINT "products_blocks_content_columns_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_blocks_content_columns" ADD CONSTRAINT "_products_v_blocks_content_columns_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "products_blocks_content_columns_media_idx" ON "products_blocks_content_columns" USING btree ("media_id");
  ...
  CREATE INDEX "_products_v_blocks_content_columns_media_idx" ON "_products_v_blocks_content_columns" USING btree ("media_id");
